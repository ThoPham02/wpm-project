...
func GetPointHandler(svcCtx *svc.ServiceContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		getPointLogic := point.NewGetPointLogic(ctx, svcCtx, logHelper)

		// Call functions in logic to process
		response, err := getPointLogic.GetPoint()
		if err != nil {
